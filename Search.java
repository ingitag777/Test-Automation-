...
WebDriver driver;
	...
	static ExtentReports report = new ExtentReports("F:\\ExtentReportresults\\search.html");
	...
	public void searchrepo() {
		test.log(LogStatus.INFO, "Searching a repository.");
		driver.findElement(By.xpath("/html/body/div[1]/header/div[3]/div/div/form/label/input[1]")).sendKeys("ingitag777/Minor-2-Customer-Driven-Billing-Sysytem");;
        driver.findElement(By.xpath("/html/body/div[1]/header/div[3]/div/div/form/label/input[1]")).sendKeys(Keys.ENTER);	
	}
	@AfterClass
